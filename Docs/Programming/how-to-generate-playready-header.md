...
The PlayReady Server SDK contains the **PlayReadyHeader** class that can be used to construct a PlayReady Header. It includes methods you can use and properties you can fill in with the information required for a PlayReady Header. The PlayReady Server SDK also includes a sample packager (AESPackaging) that demonstrates how to create a PlayReady Header.
...
Things you need before you begin.
  ...
  2. Y have to know the encryption type (AESCTC or AESCBC).
  3. Create the PlayReady object.
  4. Create the PlayReady header inside the PlayReady object using the Windows 10 PlayReadyHeaderContentHeader class.
...
Things you need before you begin.
  1. You have to have the KeyID(s) that were generated by the key management system.
  2. Y have to know the encryption type (AESCTC or AESCBC).
  3. Create the PlayReady object using the Drm_LocalLicense_CreatePlayReadyObject method.
  4. Create the PlayReady header inside the PlayReady object using the Drm_LocalLicense_CreateRMHeader function.
