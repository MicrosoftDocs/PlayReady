...
>|Oct'17|**4.0**| - Expanded support for multiple Common Encryption Modes, includinding CBC1, CBCS, and CENS.<br/>- [Secure Delete](playreadysecuredeleteserver.md) support | 4.0.5117 | 4.0.5102 | 4.0| No longer distributed (see [PlayReady on Windows](playreadyproductsanddeliverables.md#prwindows))| &mdash;| No longer distributed|
