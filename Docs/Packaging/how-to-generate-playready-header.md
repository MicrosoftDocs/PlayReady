...
The [PlayReady Object and Header Specification](../Specifications/playready-header-specification.md) is public so it is possible, and quite simple, to write code in your appliance or service that generates a PlayReady Object and a PlayReady Header, to package content.
...
The PlayReady Header generator needs to have input parameters such as: 
  ...
  * Defaut LA URL &mdash; the default URL of the PlayReady License Server that will be issuing licenses, if known at packaging time.
